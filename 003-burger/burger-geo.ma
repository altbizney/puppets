...
//Name: model.ma
//Last modified: Fri, Nov 30, 2018 06:18:16 PM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.939004984286302 1.2999138923236184 -4.6276150478261258 ;
	setAttr ".r" -type "double3" 0.70206177811915493 212.41968911910513 0 ;
	setAttr ".rp" -type "double3" 5.2041704279367322e-18 0 0 ;
	setAttr ".rpt" -type "double3" 8.2042730977989721e-15 -4.6574019335921767e-15 -9.7888643859085992e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "70DF6701-1341-4979-2463-91806B6CC7A5";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 5.4824341278854813;
...
createNode mesh -n "bunBottomShape" -p "bunBottom";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 3 ".pt";
	setAttr ".pt[10]" -type "float3" 0 0.34086537 0 ;
	setAttr ".pt[13]" -type "float3" 0 0.34086537 0 ;
	setAttr ".dr" 3;
	setAttr ".dsm" 2;
...
createNode transform -n "group1";
	rename -uid "1962EF8D-8C45-1666-7C3A-94AA763B2882";
...
createNode mesh -n "pCubeShape2" -p "|eyes|eye|pCube2";
...
createNode mesh -n "pCubeShape1" -p "|eyes|eye|pCube1";
...
createNode transform -n "pCube2" -p "eye1";
	...
	setAttr ".r" -type "double3" -1.4887806974472493 25.354535493659313 1.1976841145002008 ;
	setAttr ".s" -type "double3" 0.16254215730455834 0.19873753013097251 0.10430626192133564 ;
createNode mesh -n "pCubeShape2" -p "|eyes|eye1|pCube2";
...
createNode transform -n "pCube1" -p "eye1";
	...
	setAttr ".t" -type "double3" 0.063174672866417314 1.2634441722976228 -0.5702299543813083 ;
	setAttr ".s" -type "double3" 0.53093613762128999 0.53093613762128999 0.53093613762128999 ;
createNode mesh -n "pCubeShape1" -p "|eyes|eye1|pCube1";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "2EC1C479-004C-C7B7-DBE0-22A9B2977C60";
	setAttr -s 9 ".lnk";
	setAttr -s 9 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "B7B4B0FC-A34C-B96C-F3EE-8E842BE82C3B";
createNode displayLayer -n "defaultLayer";
	rename -uid "625FA62A-DF48-225A-F009-0B9FDCAE455C";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "166AAA1A-8A4A-E9CD-99AB-BEB8BD80BCE0";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "2E4A7FE9-B541-44D5-E371-CAA7F975A355";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "E4FAD9EF-3A4E-9041-872B-7981518557BC";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "19158C76-8F4B-A616-C13B-7395B8AED268";
...
connectAttr "polySmoothFace2.out" "|eyes|eye|pCube1|pCubeShape1.i";
...
connectAttr "|eyes|eye|pCube1|pCubeShape1.iog" "lambert6SG.dsm" -na;
connectAttr "|eyes|eye1|pCube1|pCubeShape1.iog" "lambert6SG.dsm" -na;
connectAttr "lambert6SG.msg" "materialInfo5.sg";
connectAttr "eyeballMat.msg" "materialInfo5.m";
connectAttr "surfaceShader1.oc" "surfaceShader1SG.ss";
connectAttr "|eyes|eye|pCube2|pCubeShape2.iog" "surfaceShader1SG.dsm" -na;
connectAttr "|eyes|eye1|pCube2|pCubeShape2.iog" "surfaceShader1SG.dsm" -na;
